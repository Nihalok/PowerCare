...
<body class="bg-darkbg text-darktext overflow-x-hidden relative">
  ...
  <main class="pt-20">
    <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden">
      <video class="absolute w-full h-full object-cover opacity-40 " autoplay muted loop>
      ...
      <div class="relative text-center px-4 max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="login.php"
            class="px-8 py-3 bg-primary text-white rounded-full hover:bg-accent transition font-medium">
            Submit Feedback
          </a>
          <a href="#features"
            class="px-8 py-3 border-2 border-white text-white rounded-full hover:bg-white hover:text-black transition font-medium">
            Learn More
          </a>
        </div>
      </div>
    ...
    <section class="py-20 bg-gradient-to-r from-purple-900 to-black">
      <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <a href="signup.php"
          class="px-8 py-4 bg-primary text-white rounded-full hover:bg-accent transition text-lg font-semibold">
  ...
  <footer class="bg-black py-12">
    <div class="max-w-6xl mx-auto px-4">
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
        <p>&copy; 2023 PowerCare. All rights reserved. | <a href="./pages/TnC/index.html"
            class="hover:text-primary transition">Terms of Service</a> | <a href="#"
            class="hover:text-primary transition">Privacy Policy</a></p>
      </div>
    </div>
  </footer>
</body>
